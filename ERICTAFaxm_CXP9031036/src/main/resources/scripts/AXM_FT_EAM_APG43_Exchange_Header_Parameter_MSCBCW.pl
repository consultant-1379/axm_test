#!/usr/bin/perl
#
# SCRIPT NAME:AXM_FT_EAM_APG43_Exchange_Header_Parameter_MSCBCW.pl
...
#
# Usage :  bash RUNME -t AXM_FT_EAM_APG43_Exchange_Header_Parameter_MSCBCW.pl:<node name>.
#
...
open(RFH,"AXM_FT_EAM_APG43_Exchange_Header_Parameter_MSCBCW.txt");
...
system("/bin/cat AXM_FT_EAM_APG43_Exchange_Header_Parameter_MSCBCW.txt | /bin/grep FAIL ");
if ($? == 0)
{
print  "FAIL\n";
}
