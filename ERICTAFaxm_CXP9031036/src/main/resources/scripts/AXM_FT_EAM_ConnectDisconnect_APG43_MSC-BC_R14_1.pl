...
#!/usr/bin/perl
#
# SCRIPT NAME:AXM_FT_EAM_ConnectDisconnect_APG43_MSC-BC_R14_1.pl
...
#
# Usage :  bash RUNME -t AXM_FT_EAM_ConnectDisconnect_APG43_MSC-BC_R14_1.pl.
#
...
open(RFH,">AXM_FT_EAM_ConnectDisconnect_APG43_MSC-BC_R14_1.txt");
